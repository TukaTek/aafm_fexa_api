...
public class Client
{
    ...
    public ClientCustomFields? CustomFieldValues { get; set; }
    ...
    [JsonPropertyName("default_general_address")]
    public ClientAddress? DefaultGeneralAddress { get; set; }
    
    [JsonPropertyName("default_billing_address")]
    public ClientAddress? DefaultBillingAddress { get; set; }
...
public class ClientCustomFields
{
    ...
    [JsonPropertyName("client_relations")]
    public string? ClientRelations { get; set; }
    
    [JsonPropertyName("invoicing_method")]
    public string? InvoicingMethod { get; set; }
    
    [JsonPropertyName("non_fexa_ivr_number")]
    public string? NonFexaIvrNumber { get; set; }
    
    [JsonPropertyName("client_work_order_verbiage")]
    public string? ClientWorkOrderVerbiage { get; set; }
}
